...
**最終更新**: 2026-04-15
**対象バージョン**: `sasa/develop` ブランチ (Phase 1〜8 + Tachibana Phase 1〜3 + R3 アーキテクチャ刷新 + Fixture 直接起動 + Auto-play タイムアウト廃止 + R4-1 Dead Code 除去 + R4-2 フィールド非公開化 + R4-5 テストヘルパー共通化 + R4-3 ReplaySession State Machine 導入 + R4-4 ReplayMessage 責務分割 + P1 seek_to 統一 + P2 play_with_range 追加 完了)
**関連ドキュメント**:
