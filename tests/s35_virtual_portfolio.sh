...
{
  "layout_manager":{"layouts":[{"name":"S35","dashboard":{"pane":{
    "KlineChart":{
...
api_post /api/replay/order \
  '{"ticker":"BTCUSDT","side":"buy","qty":0.1,"order_type":"market"}' > /dev/null
api_post /api/replay/order \
  '{"ticker":"BTCUSDT","side":"sell","qty":0.05,"order_type":"market"}' > /dev/null
